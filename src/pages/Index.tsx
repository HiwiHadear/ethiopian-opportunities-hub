      ...
      <footer className="bg-primary text-primary-foreground py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-muted-foreground text-base">
                <li><Link to="/tenders" className="hover:text-primary-foreground">Browse Tenders</Link></li>
                <li><Link to="/jobs" className="hover:text-primary-foreground">Find Jobs</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-muted-foreground text-base">
                <li><a href="#" className="hover:text-primary-foreground">Post Tenders</a></li>
                <li><a href="#" className="hover:text-primary-foreground">Hire Talent</a></li>
                <li><a href="#" className="hover:text-primary-foreground">Company Profile</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-muted-foreground text-base">
                <li>
                  <ContactDialog>
                    <button className="hover:text-primary-foreground transition-colors">Contact Us</button>
                  </ContactDialog>
                </li>
          ...
          <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground">
            <p className="text-base">&copy; 2026 Geza Shekalo. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
